    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          toast.success(
            <div onClick={() => window.location.href = '/orders'} className="cursor-pointer">
              <p className="font-bold">🎉 Đơn hàng mới: {payload.new.code}</p>
              <p className="text-sm">Tổng tiền: {new Intl.NumberFormat('vi-VN').format(payload.new.total_amount)} đ</p>
